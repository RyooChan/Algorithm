...
1 초	128 MB	5758	4019	3429	71.812%
문제
...
public class Main {
	public static void main(String[] args) {
		...
		int N = sc.nextInt();
    // arraylist를 사용하여 원하는 인덱스에 값을 넣을 수 있다.
		ArrayList<Integer> student = new ArrayList<>();
		
    // 학생 수에 맞추어 진행한다.
		for(int i=0; i<N; i++) {
			int num = sc.nextInt();
      // num은 무조건 i보다 작거나 같다. i번째 학생이 num을 뽑으면 i-num번째로 들어가면 해결된다. 학생 번호는 1부터 시작하므로 i+1을 넣어준다.
			student.add(i-num, i+1);
		}
